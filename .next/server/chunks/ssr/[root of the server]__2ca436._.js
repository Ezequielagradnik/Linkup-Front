...
function ModulePage({ params }) {
    ...
    const handleSectionComplete = (sectionId, responses)=>{
        // Simplemente avanzar a la siguiente sección sin guardar progreso
        if (module?.content?.sections && currentSectionIndex < module.content.sections.length - 1) {
            setCurrentSectionIndex((prev)=>prev + 1);
            toast({
                title: "Sección completada",
                description: "Has avanzado a la siguiente sección."
            });
        }
    };
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__2ca436._.js.map