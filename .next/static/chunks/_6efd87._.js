(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_6efd87._.js", {
...
const toastVariants = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$class$2d$variance$2d$authority$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cva"])("data-[swipe=move]:transition-none group relative pointer-events-auto flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md border p-6 pr-8 shadow-lg transition-all data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=open]:slide-in-from-top-full data-[state=open]:sm:slide-in-from-bottom-full data-[state=closed]:slide-out-to-right-full", {
    variants: {
        variant: {
...
function useToast() {
    ...
    const toast = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useToast.useCallback[toast]": ({ title, description, variant })=>{
            setToasts({
                "useToast.useCallback[toast]": (currentToasts)=>[
                        ...currentToasts,
                        {
                            id: Date.now(),
                            title,
    ...
    const dismissToast = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useToast.useCallback[dismissToast]": (id)=>{
            setToasts({
                "useToast.useCallback[dismissToast]": (currentToasts)=>currentToasts.filter({
...
_s(useToast, "VqPxegpo2HhnW5geFw+yQJkHXE0=");
;
var _c, _c1, _c2, _c3, _c4, _c5, _c6, _c7, _c8, _c9, _c10, _c11;
...
"[project]/components/ui/use-toast.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
const useToast = __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$toast$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"];
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$use$2d$toast$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/components/ui/use-toast.jsx [app-client] (ecmascript)");
...
function ApplyNow() {
    ...
    const { toast } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$use$2d$toast$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"])();
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        try {
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_BACKEND_URL}/api/apply`, {
                method: "POST",
                headers: {
...
_s(ApplyNow, "bhr6E0gHqG7V46WmmNvXlnF0uxI=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$use$2d$toast$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
});
_c = ApplyNow;
var _c;
...
//# sourceMappingURL=_6efd87._.js.map