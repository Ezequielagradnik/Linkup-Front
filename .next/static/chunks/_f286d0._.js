(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_f286d0._.js", {
...
function Dashboard() {
    ...
    const handleNavigation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Dashboard.useCallback[handleNavigation]": (path)=>{
            if (!user) {
                router.push("/login");
                return;
            }
            if (isTokenExpired()) {
                refreshToken().then({
                    "Dashboard.useCallback[handleNavigation]": (refreshed)=>{
                        if (refreshed) {
                            router.push(path);
                        } else {
                            router.push("/login");
                ...
                }["Dashboard.useCallback[handleNavigation]"]);
            } else {
                router.push(path);
            }
        }
...
_s(Dashboard, "urb3/v2yvesk4exJBvt7CzgVGbY=", false, function() {
    return [
...
//# sourceMappingURL=_f286d0._.js.map