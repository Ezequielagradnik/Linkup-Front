...
export function Hero({ language }) {
  const content = {
    ...
    es: {
      ...
      description:
        "Únete a la plataforma definitiva para startups. Obtén orientación experta, conéctate con mentores y accede a los recursos que necesitas para alcanzar el éxito empresarial.",
